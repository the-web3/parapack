...
//             horizontal={true}
//           >
//             {activity?.lists?.slice(0, 3).map((v, i) => (
...
//               ?.filter((v) => {
//                 if (selectedTime === '6小时') {
//                   return v.timeZone === '6h';
//                 } else if (selectedTime === '24小时') {
//                   return v.timeZone === '24h';
//                 }
//                 return true;
//               })
//               .map((v, i) => (
...
//             horizontal={true}
//           >
//             {activity?.lists?.slice(4, 7).map((v, i) => (
//               <View style={{ width: 250 }}>
//                 <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
//               </View>
//             ))}
...
//             horizontal={true}
//           >
//             {activity?.lists?.slice(8, 11).map((v, i) => (
//               <View style={{ width: 250 }}>
//                 <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
//               </View>
//             ))}
...
export const DAppScreen = (props: DAppProps) => {
  ...
  const [tags, setTags] = useState<string[]>([]);
  const [selectedTime, setSelectedTime] = useState('6小时');
  // Define a filteredDAppGroupTime variable to hold the filtered data
  const filteredDAppGroupTime =
    selectedTime === '6小时'
      ? dAppGroupTime?.lists?.filter((v) => v.time === '6小时')
      : dAppGroupTime?.lists?.filter((v) => v.time === '24小时');
  ...
  const rqDatas = async () => {
    try {
      ...
      const dAppGroupTimeRes = await getDAppGroup({
        pageNum: 1,
        pageSize: 10,
        symbol: 'eth',
        timeType: '6h', //24h
  ...
  const onDevloperApplication = () => {
    if (hasFilledForm) {
      ...
      console.log('navigate to developer application form');
      props?.navigation.navigate('DevloperApplication');
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 20, minHeight: 200 }}>
        ...
        <View style={{ marginTop: 1 }}>
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupHot?.lists?.slice(0, 3).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupHot?.lists?.slice(4, 7).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupHot?.lists?.slice(7, 11).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
        ...
        <View style={{ marginTop: 1 }}>
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupNew?.lists?.slice(11, 14).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupNew?.lists?.slice(15, 18).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupNew?.lists?.slice(19, 22).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
        ...
        <View style={{ marginTop: 1 }}>
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupLike?.lists?.slice(22, 25).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupLike?.lists?.slice(25, 28).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
          ...
          <ScrollView
            ...
            horizontal={true}
          >
            {dAppGroupLike?.lists?.slice(29, 32).map((v, i) => (
              <View style={{ width: 250 }}>
                <DAppItem {...v} key={v.title + String(i)} onPress={() => onHotPress(v)} />
              </View>
            ))}
