...
export const DAppDetail = (props: DAppDetail) => {
    ...
    const [kLine, setKLine] = useState<{ labels: string[]; datasets: any[] }>({
        ...
        datasets: [
            {
                data: (MockPrices as Array<any>).map(v => v[1]),
        ...
        <View style={styles.container}>
            <ScrollView>
                <View style={styles.headerBg}>
                    <Image source={require('@assets/images/bsc.jpg')} style={{ width: 85, height: 85 }}></Image>
                    <View style={{ flex: 1, flexDirection: 'column', gap: 3, marginLeft: 15 }}>
                        <Text style={{ color: '#252525', fontSize: 16, fontWeight: '500' }}>Biunance</Text>
                        <Text style={{ color: '#AEAEAE', fontSize: 13 }}>Bianblockchain.dajiw</Text>
                ...
                <Text style={{ color: '#5D5D5D', fontSize: 12, marginHorizontal: 20, marginTop: 30 }}>
                    Binance交易所是一个区块链交易平台,binance官方网站是全球领先的数字资产交易平台，提供便捷的区块链资产兑换业务...
                </Text>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20 }}>
                    ...
                    <Text style={{ color: '#8C8C8C', fontSize: 10 }}>BNB/USDT</Text>
                ...
                <View style={{ flexDirection: 'column', backgroundColor: '#F2F3F6', borderRadius: 10, margin: 20, marginTop:-10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, }}>
                        <Image source={{ uri: 'https://randomuser.me/api/portraits/men/36.jpg' }} style={{
                            width: 20, height: 20, borderRadius: 10
                        }} />
