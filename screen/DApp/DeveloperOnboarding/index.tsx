    ...
    <ScrollView style={theme.scrollContainer}>
      <View style={theme.container}>
        ...
        <View style={{ flex: 7, marginBottom: 20 }}>
          <Text>1.1. ParaPack钱包：指由公司开发和维护的加密货币钱包应用程序，包括但不限于“ParaPack”钱包。</Text>
          <Text>
        ...
        <View style={{ flex: 7, marginBottom: 20 }}>
          <Text> 2.1. 条件：开发者须满足公司规定的入驻条件，并提交相关材料和信息。 </Text>
          <Text>
        ...
        <View style={{ flex: 7, marginBottom: 20 }}>
          <Text>3.1. 条款：一旦入驻申请被批准，开发者可以向ParaPack钱包注入其开发的应用程序或内容。</Text>
          <Text>
            3.2.
        ...
        <View style={{ flex: 7, marginBottom: 20 }}>
          <Text>本协议受[您所在地区]法律管辖，并应按其解释和执行。 </Text>
        </View>
        ...
        <View style={{ flex: 7, marginBottom: 20 }}>
          <Text>本协议自[日期]起生效，自开发者首次入驻ParaPack钱包起生效</Text>
        </View>
      </View>
    </ScrollView>
  );
