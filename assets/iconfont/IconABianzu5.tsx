...
let IconABianzu5: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconABianzu5.defaultProps = {
  size: 18,
};

IconABianzu5 = React.memo ? React.memo(IconABianzu5) : IconABianzu5;

export default IconABianzu5;
