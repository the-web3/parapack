...
export const useMetamaskBridge = (props: MetamaskBridgeProps) => {
    ...
    if (type === 'eth_rpc_request') {
      switch (method) {
        ...
        case 'metamask_getProviderState':
          {
            r = getProviderState(activeWallet);
          }
          break;
        case 'eth_requestAccounts':
        case 'eth_accounts':
          {
            r = accounts(activeWallet);
          }
          break;
        case 'net_version':
          {
        ...
        case 'eth_blockNumber':
          {
            r = await getBlockNumber();
          }
          break;
        case 'eth_estimateGas':
          {
            r = await getEstimateGas(payload);
          }
          break;
        case 'eth_gasPrice':
          {
        ...
        case 'eth_getCode':
          {
            r = await getCode(payload);
          }
          break;
        case 'eth_coinbase':
          {
            r = await getCoinbase(activeWallet);
          }
          break;
        case 'net_listening':
          {
            r = await getNetListening();
          }
          break;
        case 'net_peerCount':
          {
            r = await getNetPeerCount();
          }
          break;
        case 'eth_protocolVersion':
          {
            r = await getEthProtocolVersion();
          }
          break;
        case 'eth_getBalance':
          {
            r = await getEthBalance(payload);
          }
          break;
        case 'eth_getBlockByNumber':
          {
            r = await getBlockByNumber(payload);
          }
          break;
        case 'eth_getBlockByHash':
          {
            r = await getBlockByHash(payload);
          }
          break;
        case 'eth_getStorageAt':
          {
            r = await getStorageAt(payload);
          }
          break;
        case 'eth_getTransactionByBlockHashAndIndex':
          {
            r = await getTransactionByBlockHashAndIndex(payload);
          }
          break;
        case 'eth_getTransactionByBlockNumberAndIndex':
          {
            r = await getTransactionByBlockNumberAndIndex(payload);
          }
          break;
        case 'eth_getTransactionByHash':
          {
            r = await getTransactionByHash(payload);
          }
          break;
        case 'eth_getTransactionCount':
          {
            r = await getTransactionCount(payload);
          }
          break;
        case 'eth_getTransactionReceipt':
          {
            r = await getTransactionReceipt(payload);
          }
          break;
        case 'eth_getUncleByBlockHashAndIndex':
          {
            r = await getUncleByBlockHashAndIndex(payload);
          }
          break;
        case 'eth_getUncleByBlockNumberAndIndex':
          {
            r = await getUncleByBlockNumberAndIndex(payload);
          }
          break;
        case 'eth_getBlockTransactionCountByHash':
          {
            r = await getBlockTransactionCountByHash(payload);
          }
          break;
        case 'eth_getBlockTransactionCountByNumber':
          {
            r = await getBlockTransactionCountByNumber(payload);
          }
          break;
        case 'eth_getWork':
          {
        ...
        case 'eth_submitWork':
          {
            r = await ethSubmitWork(payload);
          }
          break;
        case 'web3_sha3':
          {
            r = await web3Sha3(payload);
          }
          break;
        case 'eth_call':
          {
            r = await ethCall(payload);
          }
          break;
        case 'personal_sign':
          {
            r = await personalSign(payload, privateKey);
          }
          break;
        case 'personal_ecRecover':
          {
            r = await personalEcRecover(payload);
          }
          break;
        case 'eth_signTransaction':
        case 'eth_sendTransaction':
          {
            r = await ethTransaction(payload, privateKey);
          }
          break;
        case 'eth_sendRawTransaction':
          {
            r = await ethRawTransaction(payload);
          }
          break;
        case 'eth_signTypedData':
          {
            r = await ethSignTypedData(payload, privateKey);
          }
          break;
        case 'eth_signTypedData_v3':
          {
            r = await ethSignTypedDataV3(payload, privateKey);
          }
          break;
        case 'eth_signTypedData_v4':
          {
            r = await ethSignTypedDataV4(payload, privateKey);
          }
          break;
        case 'eth_sign':
          {
            r = await ethSign(payload, privateKey);
          }
          break;
  ...
  const ethTransaction = (payload: any, privateKey: string) =>
